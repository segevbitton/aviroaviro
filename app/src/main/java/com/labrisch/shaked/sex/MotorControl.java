...
public class MotorControl extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        address = newInt.getStringExtra("SEX_ADDRESS");


        sexBar = (SeekBar) findViewById(R.id.sexBar);
        sexBar.setMax(10);
        ...
        sexBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                if(fromUser = true)
                {
                    ...
                    {
                        msg("Error trying to send data btSocket");
                    }
                }
            }
